    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <button class="btn btn-sm btn-primary"
                        ...
                        data-toggle="modal"
                        data-target="#taskCreateModal" style="margin-left: 1000px">
                    <i>Create task</i></button>
            </div>
        ...
        <div class="modal fade" id="taskCreateModal">
            <div class="modal-dialog">
                <form action="{{route('tasks.create',['id' => $board->id])}}" method="POST">
                    @csrf
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="taskCreateName" class="form-control @if ($errors->has('name')) is-invalid @endif" />
                            </div>
                                @if ($errors->has('description'))
                                    <div class="alert alert-danger">{{$errors->first('description')}}</div> @endif
                            <div class="form-group">
                                <label for="taskCreateDescription">Description</label>
                                <input type="text" name="description" id="taskCreateDescription" class="form-control @if ($errors->has('description')) is-invalid @endif" />
                            </div>
                                @if ($errors->has('assignment'))
                                    <div class="alert alert-danger">{{$errors->first('assignment')}}</div> @endif
                            <div class="form-group">
                                <label for="taskCreateAssignment">Assignment</label>
                                <select class="custom-select rounded-0" name="assignment" id="taskCreateAssignment" class="form-control @if ($errors->has('assignment')) is-invalid @endif">
                                ...
                                @if ($errors->has('status'))
                                    <div class="alert alert-danger">{{$errors->first('status')}}</div> @endif
                            <div class="form-group">
                                <label for="taskCreateStatus">Status</label>
                                <select class="custom-select rounded-0" id="taskCreateStatus" name="status" class="form-control @if ($errors->has('status')) is-invalid @endif">
