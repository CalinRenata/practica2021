...
@section('content')
    <div class="register-box" style="margin-left: auto; margin-right: auto; margin-top: 100px">
        ...
        <div class="card">
            <div class="card-body register-card-body">
                ...
                <form action="{{route('register')}}" method="post">
                    ...
                    <div class="input-group mb-3">
                        <input type="password" class="form-control" name="retype_pass" placeholder="Retype password">
                        <div class="input-group-append">
                            <div class="input-group-text">
                                <span class="fas fa-lock"></span>
                            </div>
                    ...
                    <div class="input-group mb-3">
                        <input class="form-control" id="remember_token" name="remember_token" type="hidden"
                               value="{{ @csrf_token() }}">
                    </div>
                    <div class="row">
                        <div class="col-8">
